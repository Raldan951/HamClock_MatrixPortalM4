# HamClockV1.8: FT8, General, Settings, World Modes with Buttons - Hybrid BMP/Code
...
matrix = Matrix(width=64, height=64, bit_depth=2)
...
local_label = label.Label(terminalio.FONT, text="00:00:00", color=0x00FF00, x=8, y=8)  # 76
