...
class OpenWeather_Graphics(displayio.Group):
    def __init__(
        ...
        self.dir_text = Label(self.small_font, max_glyphs=10)
        self.dir_text.color = WIND_COLOR
        self._scrolling_texts.append(self.dir_text)
    ...
    def display_weather(self, weather):
        ...
        print(direction)
        self.dir_text.text = "from %d°" % direction
